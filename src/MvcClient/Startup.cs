    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            var openIdOptions = new OpenIdConnectOptions
            {
                ...
                CallbackPath = new PathString("/openid-callback"),
                ClientId = "mvc",
                ClientSecret = "mvc",
                ...
                Events = new OpenIdConnectEvents
                {
                    ...
                    OnTokenValidated = x =>
                    {
                        ...
                        var identity = (ClaimsIdentity)x.Ticket.Principal.Identity;
                        identity.AddClaims(new[]
                        {
            ...
            // openid is already present by default: https://github.com/aspnet/Security/blob/59a86c17e2bfbad5ed2fe57f44a3054d17f07f89/src/Microsoft.AspNetCore.Authentication.OpenIdConnect/OpenIdConnectOptions.cs#L55
